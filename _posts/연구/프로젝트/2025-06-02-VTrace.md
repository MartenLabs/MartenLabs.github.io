...
- **학습 데이터 생성**  
    보컬 감쇠 처리 과정에서 생성된 **Residual Vocal**은 새로운 AI 학습 데이터로 재활용할 수 있습다.
...
| **Alpha=0.1**  | <audio controls> <source src="https://tera.dscloud.me:8080/Files/Project/VTrace/Samples/Miiro/Mirro_blend_0.075.mp3" type="audio/mp3">Your browser does not support the audio element.</audio> |
